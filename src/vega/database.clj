...
(defn create-migration-table-query [keyspace]
  (format "CREATE TABLE IF NOT EXISTS %s.ragtime-migrations (id varchar, created_at timestamp, PRIMARY KEY (id))" keyspace))
(defn ensure-migration-table! [session keyspace] (alia/execute session
